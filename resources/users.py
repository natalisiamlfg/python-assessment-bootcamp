...
_user_parser.add_argument('confirmEmail', type=str, required=True,
                          help="This field cannot be blank")
_user_parser.add_argument('password', type=str, required=True,
                          help="This field cannot be blank"),
_user_parser.add_argument('confirmPassword', type=str, required=True,
                          help="This field cannot be blank")
...
class UserRegister(Resource):
    def post(self):
        ...
        if data['email'] != data['confirmEmail']:
            return{'message': "emails don't match"}, 400
